...
pub use write::{
    ...
    write_streaming_encrypted_compressed_archive_to, ArchiveEntry, ArchiveExtras,
    ...
    FilterKind, FilterPolicy, Rar50VolumeWriter, Rar50Writer, ServiceEntry, StoredEntry,
    StoredEntryWithServices, StoredServiceEntry, StreamingCompressedEntry,
    StreamingEncryptedCompressedEntry, WriterOptions,
};
