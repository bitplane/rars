...
| Prepared headers and member/service records | Retained for archive construction and not yet covered by capacity accounting. RAR5/7 service payloads borrow writer input; preparation makes no additional plaintext or ciphertext payload copy. Upstream input construction may still allocate. |
